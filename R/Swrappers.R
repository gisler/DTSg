...
#' @param clone A logical specifying if the object is modified in place or if a
#'  clone (copy) is made beforehand.
#' @param newCols An optional character vector of the same length as
...
#'  are matched elementwise between \code{newCols} and \code{cols}.
...
#'  used when \code{newCols} is not specified.
#'
#' @details
