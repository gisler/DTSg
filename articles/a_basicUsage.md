...
it to the [`new()`](https://gisler.github.io/DTSg/reference/DTSg.md)
...
([`summary()`](https://gisler.github.io/DTSg/reference/summary.DTSg.md)),
a report on missing values
([`nas()`](https://gisler.github.io/DTSg/reference/nas.DTSg.md)) and a
plot ([`plot()`](https://gisler.github.io/DTSg/reference/plot.DTSg.md)).
It suddenly seems to contain several missing values, which apparently
were not there upon loading the data set
([`plot()`](https://gisler.github.io/DTSg/reference/plot.DTSg.md)
...
of the [`cols()`](https://gisler.github.io/DTSg/reference/cols.DTSg.md)
...
With [`alter()`](https://gisler.github.io/DTSg/reference/alter.DTSg.md)
...
[`merge()`](https://gisler.github.io/DTSg/reference/merge.DTSg.md)
method though.
...
- [`getCol()`](https://gisler.github.io/DTSg/reference/getCol.DTSg.md)
  or
  [`` `[.DTSg`() ``](https://gisler.github.io/DTSg/reference/getCol.DTSg.md)
- [`refresh()`](https://gisler.github.io/DTSg/reference/refresh.DTSg.md)
