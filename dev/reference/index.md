...
- [`new()`](https://gisler.github.io/DTSg/dev/reference/DTSg.md) : DTSg
  class
...
- [`rowbind(`*`<DTSg>`*`)`](https://gisler.github.io/DTSg/dev/reference/rowbind.DTSg.md)
  : Combine rows
- [`setColNames(`*`<DTSg>`*`)`](https://gisler.github.io/DTSg/dev/reference/setColNames.DTSg.md)
  : Set column names
- [`setCols(`*`<DTSg>`*`)`](https://gisler.github.io/DTSg/dev/reference/setCols.DTSg.md)
  : Set column values
- [`subset(`*`<DTSg>`*`)`](https://gisler.github.io/DTSg/dev/reference/subset.DTSg.md)
...
- [`flow`](https://gisler.github.io/DTSg/dev/reference/flow.md) : Daily
  river flows
