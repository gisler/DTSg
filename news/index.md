...
- The day saving time shift for the `ignoreDST` argument of the
  [`aggregate()`](https://gisler.github.io/DTSg/reference/aggregate.DTSg.md),
  [`colapply()`](https://gisler.github.io/DTSg/reference/colapply.DTSg.md)
  and
  [`subset()`](https://gisler.github.io/DTSg/reference/subset.DTSg.md)
...
- Sped up the
  [`byY_____()`](https://gisler.github.io/DTSg/reference/TALFs.md) and
  [`byYm____()`](https://gisler.github.io/DTSg/reference/TALFs.md) TALFs
  of the `"base"` `funbyApproach`.
- The [`print()`](https://gisler.github.io/DTSg/reference/print.DTSg.md)
...
- Fixed that the
  [`setCols()`](https://gisler.github.io/DTSg/reference/setCols.DTSg.md)
  method and its R6 only alias
  [`set()`](https://gisler.github.io/DTSg/reference/setCols.DTSg.md) was
  too anxious about removing all value columns.
...
- Column names can often now be additionally specified by a character
  ...
  example, `"x:z"`.
- Fixed a bug in the
  [`interpolateLinear()`](https://gisler.github.io/DTSg/reference/interpolateLinear.md)
...
- Added `funbyApproach` argument to the
  [`new()`](https://gisler.github.io/DTSg/reference/DTSg.md),
  [`aggregate()`](https://gisler.github.io/DTSg/reference/aggregate.DTSg.md),
  [`colapply()`](https://gisler.github.io/DTSg/reference/colapply.DTSg.md)
  and
  [`subset()`](https://gisler.github.io/DTSg/reference/subset.DTSg.md)
...
- Added `funbyApproach` field reflecting the individual `funbyApproach`
  ...
  utilised approach).
- Added undocumented
  [`names()`](https://gisler.github.io/DTSg/reference/cols.DTSg.md)
  method exclusively to the R6 interface acting as an alias for the
  [`cols()`](https://gisler.github.io/DTSg/reference/cols.DTSg.md)
  method.
...
- Added `DTSgFast`, `DTSgFunbyApproach` and `DTSgNA.status` options
  ...
  [`new()`](https://gisler.github.io/DTSg/reference/DTSg.md) method.
- Added `DTSgDeprecatedWarnings` option: allows for disabling warnings
  from deprecated features.
- Greatly sped up the
  [`by______()`](https://gisler.github.io/DTSg/reference/TALFs.md) and
  `byFasttime______()` TALFs.
...
- Added a “special class” called `".numerary"` available to the `class`
  ...
  columns in one go.
- Added undocumented
  [`raggregate()`](https://gisler.github.io/DTSg/reference/rowaggregate.DTSg.md),
  [`rbind()`](https://gisler.github.io/DTSg/reference/rowbind.DTSg.md),
  [`set()`](https://gisler.github.io/DTSg/reference/setCols.DTSg.md) and
  [`setnames()`](https://gisler.github.io/DTSg/reference/setColNames.DTSg.md)
  methods exclusively to the R6 interface acting as aliases for the
  [`rowaggregate()`](https://gisler.github.io/DTSg/reference/rowaggregate.DTSg.md),
  [`rowbind()`](https://gisler.github.io/DTSg/reference/rowbind.DTSg.md),
  [`setCols()`](https://gisler.github.io/DTSg/reference/setCols.DTSg.md)
  and
  [`setColNames()`](https://gisler.github.io/DTSg/reference/setColNames.DTSg.md)
  methods.
- The [`print()`](https://gisler.github.io/DTSg/reference/print.DTSg.md)
...
- Added `helpers` argument to the
  [`colapply()`](https://gisler.github.io/DTSg/reference/colapply.DTSg.md)
  and
  [`rollapply()`](https://gisler.github.io/DTSg/reference/rollapply.DTSg.md)
...
- Added `[` extract operator: acts as a shortcut for the
  [`getCol()`](https://gisler.github.io/DTSg/reference/getCol.DTSg.md)
  method.
...
- The
  ...
  summary functions.
- Greatly sped up the
  [`nas()`](https://gisler.github.io/DTSg/reference/nas.DTSg.md) method.
...
- The `R6Method` argument of the
  [`S3WrapperGenerator()`](https://gisler.github.io/DTSg/reference/S3WrapperGenerator.md)
...
- Fixed that not all missing values were made explicit after a call to
  the [`merge()`](https://gisler.github.io/DTSg/reference/merge.DTSg.md)
...
- Added `na.status` argument to the
  [`new()`](https://gisler.github.io/DTSg/reference/DTSg.md) and
  [`alter()`](https://gisler.github.io/DTSg/reference/alter.DTSg.md)
...
- Fixed error “Error in as.POSIXct.numeric(e) : ‘origin’ must be
  ...
  [`rollback()`](https://gisler.github.io/DTSg/reference/rollback.md)
...
- Added `drop` argument to the
  [`values()`](https://gisler.github.io/DTSg/reference/values.DTSg.md)
...
- The [`alter()`](https://gisler.github.io/DTSg/reference/alter.DTSg.md)
  method and linked with it the
  [`new()`](https://gisler.github.io/DTSg/reference/DTSg.md) and other
  methods are now way more resource efficient in some cases.
