...
- funbyApproach:
  ...
  [`TALFs`](https://gisler.github.io/DTSg/reference/TALFs.md) used with
  the created `DTSg` object. Either `"timechange"`, which utilises
...
- `alter`: See
  [`alter`](https://gisler.github.io/DTSg/reference/alter.DTSg.md) for
  further information.

- `clone`: See
  [`clone`](https://gisler.github.io/DTSg/reference/clone.DTSg.md) for
  further information.
...
- `cols` and its R6 only alias `names`: See
  [`cols`](https://gisler.github.io/DTSg/reference/cols.DTSg.md) for
  further information.

- `getCol`: See
  [`getCol`](https://gisler.github.io/DTSg/reference/getCol.DTSg.md) for
  further information.

- `merge`: See
  [`merge`](https://gisler.github.io/DTSg/reference/merge.DTSg.md) for
  further information.

- `nas`: See
  [`nas`](https://gisler.github.io/DTSg/reference/nas.DTSg.md) for
  further information.

- `plot`: See
  [`plot`](https://gisler.github.io/DTSg/reference/plot.DTSg.md) for
  further information.

- `print`: See
  [`print`](https://gisler.github.io/DTSg/reference/print.DTSg.md) for
  further information.
...
- `subset`: See
  [`subset`](https://gisler.github.io/DTSg/reference/subset.DTSg.md) for
  further information.
...
- `values`: See
  [`values`](https://gisler.github.io/DTSg/reference/values.DTSg.md) for
  further information.
