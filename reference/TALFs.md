...
of the methods of a
[`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) object, which
supports it. The method then does the rest of the work. See respective
calling method for further information. Other uses are possible, but not
recommended.
...
- .helpers:
  ...
  [`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) objects,
