...
of a [`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) object
and aggregates its values column-wise to the function's temporal
aggregation level utilising one or more provided summary functions.
Additionally, it sets the object's
[`aggregated`](https://gisler.github.io/DTSg/reference/DTSg.md) field to
`TRUE`.
...
- funby:
  ...
  defined temporal aggregation level function. See corresponding section
