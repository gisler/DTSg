...
- na.status:
  ...
  [`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) objects work
  best with explicitly missing values.
...
[`nas`](https://gisler.github.io/DTSg/reference/nas.DTSg.md)
