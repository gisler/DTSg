...
[`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) and other
suitable objects.
...
- ...:
  ...
  Any number of
  [`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) objects or
  objects coercible to one (see
  [`new`](https://gisler.github.io/DTSg/reference/DTSg.md) for further
  information). [`list`](https://rdrr.io/r/base/list.html)s of such
  objects or a mixture of lists and non-lists are also accepted.
