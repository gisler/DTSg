...
[`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) object.
...
- x:
  ...
  A [`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) object (S3
  method only).
...
- funby:
  ...
  [`TALFs`](https://gisler.github.io/DTSg/reference/TALFs.md) or a user
  defined temporal aggregation level function. Can be used to, for
...
- multiplier:
  ...
  level of certain
  [`TALFs`](https://gisler.github.io/DTSg/reference/TALFs.md). See
...
Returns a [`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md)
object.
...
[`DTSg`](https://gisler.github.io/DTSg/reference/DTSg.md) object while
leaving the `na.status` untouched,
[`alter`](https://gisler.github.io/DTSg/reference/alter.DTSg.md) is
...
- *timezone:* Same as the
  [`timezone`](https://gisler.github.io/DTSg/reference/DTSg.md) field.

- *ignoreDST:* Same as the `ignoreDST` argument.

- *periodicity:* Same as the
  [`periodicity`](https://gisler.github.io/DTSg/reference/DTSg.md)
  field.

- *na.status:* Same as the
  [`na.status`](https://gisler.github.io/DTSg/reference/DTSg.md) field.
...
[`TALFs`](https://gisler.github.io/DTSg/reference/TALFs.md) can be
adjusted with the help of the `multiplier` argument. A `multiplier` of
`10`, for example, makes
[`byY_____`](https://gisler.github.io/DTSg/reference/TALFs.md) aggregate
to decades instead of years. Another example is a `multiplier` of `6`
provided to
[`by_m____`](https://gisler.github.io/DTSg/reference/TALFs.md). The
...
[`TALFs`](https://gisler.github.io/DTSg/reference/TALFs.md) of the
package:

- [`byY_____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`byYm____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`byYmdH__`](https://gisler.github.io/DTSg/reference/TALFs.md) (UTC
  and equivalent as well as all Etc/GMT time zones only)

- [`byYmdHM_`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`byYmdHMS`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`by_m____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`by___H__`](https://gisler.github.io/DTSg/reference/TALFs.md) (UTC
  and equivalent as well as all Etc/GMT time zones only)

- [`by____M_`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`by_____S`](https://gisler.github.io/DTSg/reference/TALFs.md)
...
- [`byYQ____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`byYm____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`byYmd___`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`by_Q____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`by_m____`](https://gisler.github.io/DTSg/reference/TALFs.md)

- [`by___H__`](https://gisler.github.io/DTSg/reference/TALFs.md)
